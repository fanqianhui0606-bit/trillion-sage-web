...
const NAV_LINKS = [
  ...
  { href: "/#values", label: "我们是谁" },

  { href: "/#quiz-teaser", label: "数理素质测验" },

  { href: "/#chat-teaser", label: "灵魂聊天共振" },

  { href: "/#consultation", label: "1v1咨询引航" },

  { href: "/#programs-preview", label: "数理线上营" },
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <Link
          ...
          className="flex items-center gap-2 text-bridge-blue font-bold text-2xl tracking-wider font-brand"

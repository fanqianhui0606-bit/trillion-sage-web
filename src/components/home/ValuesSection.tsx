...
export default function ValuesSection({
  ...
  hideBadgeWall?: boolean;
}) {
  return (
    <section id="values-content" className="flex items-center py-16 px-6 scroll-mt-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {VALUES.map((v) => (
            <GlassCard key={v.title} className="text-center">
              <h3 className="text-lg font-bold text-bridge-blue mb-3 font-sans">{v.title}</h3>
